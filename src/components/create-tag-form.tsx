    ...
    <form onSubmit={handleSubmit(createTag)} className="w-full space-y-6">
      <div className="space-y-2">
        ...
        <input
          ...
          id="name"
          type="text"
          className="border border-zinc-800 rounded-lg h-10 px-3 py-.5 bg-zinc-800/50 w-full text-sm"
        />
      ...
      <div className="space-y-2">
        ...
        <input
          ...
          readOnly
          value={slug}
          className="border border-zinc-800 rounded-lg h-10 px-3 py-2.5 bg-zinc-800/50 w-full text-sm"
        />
      </div>
